...
public class KalmanFilter {
    ...
    private double lat;
    private double lng;
    private double variance; // P matrix.  Negative means object uninitialized.  NB: units irrelevant, as long as same units used throughout

    public KalmanFilter() {
        Q_metres_per_second = 1.0f;
    }
