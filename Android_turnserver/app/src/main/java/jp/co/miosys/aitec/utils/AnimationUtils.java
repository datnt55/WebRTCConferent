...
public class AnimationUtils {
    ...
    public static void startAnimation(final View view, int delay) {
        view.setScaleX(0);
        view.setScaleY(0);
        view.setAlpha(1);
    ...
    public static void slideUp(View view, int height, int duration) {
        view.animate()
                .translationY(-height)
                .setInterpolator(AnimationUtils.EASE_OUT_EASE_IN)
                .setDuration(duration)
                .start();
    }

    public static void slideUp(View view, int start, int height, int duration) {
        view.animate().y(start)
                .translationY(height)
                .setInterpolator(AnimationUtils.EASE_OUT_EASE_IN)
                .setDuration(duration)
                .start();
    ...
    public static void slideDown(View view, int height, int duration) {
        view.animate().y(0)
                .translationY(height)
                .setInterpolator(AnimationUtils.EASE_OUT_EASE_IN)
                .setDuration(duration)
